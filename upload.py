...
# Comenta os botões da barra lateral
...
# Comenta a lógica de seleção de página, exceto para "Atualize Empresa"
...
if update_company_page:  # Mantém apenas a opção para Atualize Empresa
    st.session_state[PAGE_SELECTION_KEY] = "Atualize Empresa"
...
if st.session_state[PAGE_SELECTION_KEY] == "Atualize Empresa":
    ...
    # Bloco "Links" (completamente comentado) - Já estava comentado
    # elif option == "Links":
    #     ...

# Bloco "Empresas" (completamente comentado)
...
# Bloco "Chat" (completamente comentado)
...
#     show_citations = st.checkbox("Mostrar citações")  # Checkbox movido para antes do loop de mensagens
